...
def test_signup_failure(mock_session, mock_get_signup_info, fake_user_info):
    ...
    with patch(
        ...
        "app.controllers.collaborator_controller.show_signup_error"
    ) as mock_show_signup_error, patch("app.utils.database_utils.SessionLocal",
...
def test_signin_success(mock_session,
                        mock_query,
                        mock_ask_login,
                        mock_ask_password,
                        fake_collaborator):
...
def test_signin_failure_wrong_login(mock_session,
                                    mock_ask_login,
                                    mock_ask_password):
...
def test_signin_failure_wrong_password(mock_session,
                                       mock_query,
                                       mock_ask_login,
                                       mock_ask_password,
                                       fake_collaborator):
